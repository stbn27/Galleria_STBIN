  ...
  return (
    <header className="h-[var(--topbar-height)] shrink-0 flex items-center justify-between px-6 bg-[var(--bg-primary)] border-b border-[var(--border)]">
      <div className="flex-1 flex items-center">
        ...
        <h1 className="font-['Space_Grotesk'] font-bold text-xl text-[var(--text-primary)]">
          Galería
        </h1>
      </div>
      ...
      <div className="flex-1 flex justify-center">
        <div className="relative w-full max-w-md">
          ...
          <input 
            type="text" 
            placeholder="Buscar..." 
            className="w-full bg-[var(--bg-tertiary)] border border-[var(--border)] text-[var(--text-primary)] rounded-[var(--radius-full)] pl-10 pr-4 py-2 text-sm focus:outline-none focus:border-[var(--accent)] focus:ring-2 focus:ring-[var(--accent-subtle)] transition-all"
          />
        </div>
      </div>
